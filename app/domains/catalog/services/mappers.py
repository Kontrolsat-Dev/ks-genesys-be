...
def map_product_row_to_out(row: Any) -> ProductOut:
    ...
    return ProductOut(
        ...
        ecotax=getattr(row, "ecotax", 0),
        extra_fees=getattr(row, "extra_fees", 0),
        category_ecotax=getattr(row, "category_ecotax", None),
        category_extra_fees=getattr(row, "category_extra_fees", None),
